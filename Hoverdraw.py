...
def top_shapes_color(frame):
    ...
    cv.rectangle(frame, (572, 0), (858, 100), (255, 0, 0), cv.FILLED)
    # cv.line(frame,(572,0),(858,100),(0,0,255),2,cv.BORDER_ISOLATED)
    # cv.line(frame,(858,0),(572,100),(0,0,255),2,cv.BORDER_ISOLATED)
